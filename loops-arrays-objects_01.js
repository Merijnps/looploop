...
// Loop door de array en bereken de bijbehorende letter en sla deze op in de 'grade'-property
...
/*for (let i = 0; i < NOVIEmployees.length; i++) {
    const emailAdresses = (NOVIEmployees[i].firstName + "." + NOVIEmployees[i].lastName + '@novi.nl').toLowerCase()

        NOVIEmployees[i].email= emailAdresses
}
console.log(NOVIEmployees)*/
